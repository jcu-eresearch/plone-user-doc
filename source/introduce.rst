...
3. **Plone menu bar** 
   ...
   item. 
4. **LiveSearch** 
   A search engine that allows users to search your site for content.
5. **Main page content** 
   The main area on the page for your content. If you are looking at a folder, 
...
**LiveSearch**  box at the right of the screen. Just type in a name, and it
...
.. Once you've talked to them about the change, you can follow the steps under the 
.. next section to complete your change of name on the system.

.. Manual Changes
.. --------------

.. The only **manual change** you need to make is to the title of your user
.. folder. The system saves your name as the folder's title when your account
.. is first created and it won't automatically update if your name changes. To change
